...
NIX_CONF="https://raw.githubusercontent.com/SpreadiesInSpace/cinnamon-dotfiles"
curl -fsSL -o configuration.nix \
	"$NIX_CONF/refs/heads/main/home/theming/NixOS/configuration.nix" || \
...
nixos-enter --root /mnt -c \
	'echo "Enabling Flathub..." && flatpak remote-add --if-not-exists flathub '\
...
curl -fsSL -o Login_Wallpaper.jpg \
	"$WALL/refs/heads/main/home/wallpapers/Login_Wallpaper.jpg" || \
