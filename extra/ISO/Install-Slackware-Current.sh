...
AIS="$AIS/-/archive/v31/arch-install-scripts-v31.tar.gz"
...
retry wget -q "$AIS" \
  -O arch-install-scripts-v31.tar.gz || \
...
mv arch-install-scripts-v31.tar.gz arch-install-scripts/ \
...
installpkg /tmp/arch-install-scripts-31-noarch-1_SBo.tgz >/dev/null 2>&1 || \
