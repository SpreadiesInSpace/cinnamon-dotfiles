...
sudo rm -rf /var/lib/systemd/coredump/*; rm -rf ~/.cache/*; \
sudo rm /nix/var/nix/gcroots/auto/*; sudo nix-collect-garbage -d; \
nix-collect-garbage -d; sudo nix-store --optimise; nix-store --optimise; \
sudo nix-env -p /nix/var/nix/profiles/system --delete-generations old; \
sudo nix-env --delete-generations old; nix-env --delete-generations old; \
