...
cp -vnpr .config/bleachbit/bleachbit.ini.void ~/.config/bleachbit/bleachbit.ini
sudo mv /root/.config/bleachbit/bleachbit.ini /root/.config/bleachbit/bleachbit.ini.old
sudo mkdir -p /root/.config/bleachbit/
sudo cp -vprf .config/bleachbit/bleachbit.ini.void /root/.config/bleachbit/bleachbit.ini
...
# sudo cp Void/.bashrc /root/.bashrc
...
cp -vnpr .config/neofetch/config.conf.void ~/.config/neofetch/config.conf
sudo neofetch
...
sudo dconf load / < gnome-terminal-Void.dconf
rm ~/gnome-terminal-Void.dconf
cd ..
