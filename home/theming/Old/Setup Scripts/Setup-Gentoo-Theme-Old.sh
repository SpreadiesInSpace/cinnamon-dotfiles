...
cp -vnpr .config/bleachbit/bleachbit.ini.gentoo ~/.config/bleachbit/bleachbit.ini
sudo mv /root/.config/bleachbit/bleachbit.ini /root/.config/bleachbit/bleachbit.ini.old
sudo mkdir -p /root/.config/bleachbit/
sudo cp -vprf .config/bleachbit/bleachbit.ini.gentoo /root/.config/bleachbit/bleachbit.ini
...
cp -vnpr .config/cinnamon/spices.gentoo/* ~/.config/cinnamon/spices/
...
cp -vnpr .config/neofetch/config.conf.gentoo ~/.config/neofetch/config.conf
sudo neofetch
sudo mv /root/.config/neofetch/config.conf /root/.config/neofetch/config.conf.old
# sudo cp -vprf .config/neofetch/config.conf.gentoo /root/.config/neofetch/config.conf
...
cp -vnpr .config/menus/gentoo/* ~/.config/menus/
...
sudo dconf load / < gnome-terminal-Gentoo.dconf
rm ~/gnome-terminal-Gentoo.dconf
cd ..
...
cp -vprf .config/synth-shell/gentoo/* ~/.config/synth-shell/
