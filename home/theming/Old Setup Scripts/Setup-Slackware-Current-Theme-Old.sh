...
cp -vnpr .config/bleachbit/bleachbit.ini.slackware ~/.config/bleachbit/bleachbit.ini
sudo mv /root/.config/bleachbit/bleachbit.ini /root/.config/bleachbit/bleachbit.ini.old
sudo mkdir -p /root/.config/bleachbit/
sudo cp -vprf .config/bleachbit/bleachbit.ini.slackware /root/.config/bleachbit/bleachbit.ini
