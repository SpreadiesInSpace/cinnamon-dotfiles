...
cp -vnpr .config/bleachbit/bleachbit.ini.fedora ~/.config/bleachbit/bleachbit.ini
sudo mv /root/.config/bleachbit/bleachbit.ini /root/.config/bleachbit/bleachbit.ini.old
sudo mkdir -p /root/.config/bleachbit/
sudo cp -vprf .config/bleachbit/bleachbit.ini.fedora /root/.config/bleachbit/bleachbit.ini
...
cp -vnpr .config/cinnamon/spices.fedora/* ~/.config/cinnamon/spices/
...
cp -vnpr .config/menus/fedora/* ~/.config/menus/
