...
yes | rm -rf ~/.cache/* | sudo rm -rf /var/tmp/portage/ | \
sudo rm -rf /var/cache/distfiles/ | sudo rm -rf /var/cache/binpkgs/ | \
sudo eclean-dist --destructive | sudo eclean-pkg | \
...
alias updateApp='updateSync; \
sudo emerge -avqDuN --with-bdeps=y @world; flatpak update -y; \
updateNeovim; sudo grub-mkconfig -o /boot/grub/grub.cfg'
