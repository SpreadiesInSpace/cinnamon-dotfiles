...
alias updateApp='sudo sbocheck; sudo sboupgrade --all; sudo slpkg -u; sudo slpkg -U; sudo slpkg -U -o "slack"; sudo slpkg -U -o "slack_extra"; sudo slpkg -U -o "csb"; sudo slpkg -U -o "conraid"; sudo slpkg -U -o "alien"; sudo slpkg -U -o "restricted"; sudo slpkg -U -o "gnome"; sudo slpkg -U -o "slint"; sudo grub-mkconfig -o /boot/grub/grub.cfg; flatpak update -y'
