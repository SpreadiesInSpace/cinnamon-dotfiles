...
cp -vnpr .config/bleachbit/bleachbit.ini.openSUSE ~/.config/bleachbit/bleachbit.ini
sudo mv /root/.config/bleachbit/bleachbit.ini /root/.config/bleachbit/bleachbit.ini.old
sudo mkdir -p /root/.config/bleachbit/
sudo cp -vprf .config/bleachbit/bleachbit.ini.openSUSE /root/.config/bleachbit/bleachbit.ini
...
cp -vnpr .config/cinnamon/spices.openSUSE/* ~/.config/cinnamon/spices/
...
cp -vnpr .config/neofetch/config.conf.openSUSE ~/.config/neofetch/config.conf
sudo neofetch
sudo mv /root/.config/neofetch/config.conf /root/.config/neofetch/config.conf.old
# sudo cp -vprf .config/neofetch/config.conf.openSUSE /root/.config/neofetch/config.conf
...
cp -vnpr .config/menus/openSUSE/* ~/.config/menus/
