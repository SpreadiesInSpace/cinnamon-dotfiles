    ...
    activate (event) {
        switch (this._action) {
            ...
            case "remove_from_favorites":
                ...
                break;
            case "uninstall":
                Util.spawnCommandLine("/usr/local/bin/cinnamon-remove-application '" + this._appButton.app.get_app_info().get_filename() + "'");
                break;
...
class CinnamonMenuApplet extends Applet.TextIconApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this._canUninstallApps = GLib.file_test("/usr/local/bin/cinnamon-remove-application", GLib.FileTest.EXISTS);
        this._isBumblebeeInstalled = GLib.file_test("/usr/local/bin/optirun", GLib.FileTest.EXISTS);
    ...
    _resizeApplicationsBox() {
        ...
        this.applicationsBox.set_width(width - 5); // The answer to life...
    }
    ...
    _refreshSystemButtons() {
        ...
        button.activate = () => {
            ...
            let screensaver_dialog = Gio.file_new_for_path("/usr/local/bin/cinnamon-screensaver-command");
