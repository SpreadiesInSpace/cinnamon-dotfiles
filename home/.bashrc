...
# FreeBSD Update
alias updateNeovim='nvim --headless "+Lazy! sync" +qa'
alias updateApp='cd ./linux-browser-installer/;sudo ./linux-browser-installer chroot upgrade;sudo ./linux-browser-installer clean;cd;sudo freebsd-update fetch; sudo freebsd-update install; sudo pkg upgrade; updateNeovim'
alias updateAll='updateApp; cleanAll'
